...
import static com.dfcovid.Constants.DatabaseContract.DataEntry.COLUMN_DATE;
...
// How you want the results sorted in the resulting Cursor
    ...
    public void insertNotificationData(String bundle, String currentdate) {

        try {
            SQLiteDatabase db = this.getWritableDatabase();
            ContentValues values = new ContentValues();
            values.put(DatabaseContract.DataEntry.COLUMN_NOTIFICATION_ID, Constants.NOTIFICATION_ID);
            values.put(DatabaseContract.DataEntry.COLUMN_MESSAGE, bundle);
...
// Issue SQL statement.
    ...
    public void addDataForRead(Cursor c) {
